...
func MakeJoin() *cobra.Command {
	...
	command.RunE = func(command *cobra.Command, args []string) error {
		...
		if server {
			boostrapErr = setupAdditionalServer(serverIP, ip, port, user,  sshKeyPath, joinToken, k3sExtraArgs, k3sVersion,k3sEnv, k3sInstallShell)
		} else {
			boostrapErr = setupAgent(serverIP, ip, port, user,  sshKeyPath, joinToken, k3sExtraArgs, k3sVersion, k3sEnv,k3sInstallShell)
		}
...
func setupAdditionalServer(serverIP, ip net.IP, port int, user, sshKeyPath, joinToken, k3sExtraArgs, k3sVersion, k3sEnv,k3sInstallShell string) error {
...
func setupAgent(serverIP, ip net.IP, port int, user, sshKeyPath, joinToken, k3sExtraArgs, k3sVersion, k3sEnv,k3sInstallShell string) error {
